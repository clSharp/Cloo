[Description]
Cloo is an object oriented wrapper over OpenCL. Written in C#, it takes full advantage of the .NET framework to provide ease of use and full functionality of the underlying API.
